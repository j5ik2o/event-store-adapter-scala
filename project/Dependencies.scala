...
object Dependencies {
  ...
  object fasterxml {
    val jacksonModuleScala = "com.fasterxml.jackson.module" %% "jackson-module-scala" % "2.21.3"
  }
  ...
  object j5ik2o {
    ...
    val eventStoreAdapterJava = "io.github.j5ik2o" % "event-store-adapter-java" % "1.2.85"
  }
